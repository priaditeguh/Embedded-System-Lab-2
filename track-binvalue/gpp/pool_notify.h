...
NORMAL_API
DSP_STATUS
pool_notify_Execute (IN Uint32 numIterations, IN Uint8 processorId, int LENGTH_TO_COUNT) ;
...
NORMAL_API
Void
pool_notify_Main (IN Char8 * dspExecutable, IN Char8 * videoName, int LENGTH_TO_COUNT) ;
